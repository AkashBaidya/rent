...
class Person(models.Model):
    ...
    sis_supplier_code=models.CharField(max_length=900,blank=True)
...
class Agreement(models.Model):
    ...
    total_rou=models.IntegerField(null=True, blank=True)
    ...
    agreement_cat_type=models.CharField(verbose_name='Agreement category type',max_length=90,choices=[
        ...
        ('Amendment Of Lease Agreement -Sep-2019','Amendment Of Lease Agreement -Sep-2019'),
        ('Ground floor','Ground floor'),
        ('Possession purchase','Possession purchase'),
        ('Renewal(Extension)','Renewal(Extension)'),
        ('Space-Extension','Space-Extension')])
    termination_clause=models.CharField(max_length=70,choices=[
            ...
            ('Both parties_1 Month prior written notice','Both parties_1 Month prior written notice'),
            ('Both parties_12 Months prior written notice','Both parties_12 Months prior written notice'),
            ('Both parties_3 Months prior written notice','Both parties_3 Months prior written notice'),
            ('Both parties_4 Months prior written notice','Both parties_4 Months prior written notice'),
            ('Both parties_6 Months prior written notice','Both parties_6 Months prior written notice'),
            ('Both parties Negotiator 3 Month notice','Both parties Negotiator 3 Month notice'),
            ...
            ('Lessee only_1 Month prior written notice','Lessee only_1 Month prior written notice'),
            ('Lessee only_3 Months prior written notice','Lessee only_3 Months prior written notice'),
            ('Lessee only_4 Months prior written notice','Lessee only_4 Months prior written notice'),
            ('Lessee only_6 Months prior written notice','Lessee only_6 Months prior written notice'),
...
class Rentline(models.Model):
    ...
    def save(self,*args, **kwargs):
        if not self.entry_date:
            self.entry_date=timezone.now()
        self.modified=timezone.now()
        return super(Rentline,self).save(*args,**kwargs)
